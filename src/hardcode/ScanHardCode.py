...
def openFileStream(moduleDir):
    ...
    # generatedJavaDir = generatedRootDir + moduleDir +"/src/main/java"
    ...
    stringPath = generatedStringDir + "/string.xml"
...
def writeToStringFile(stringValue, stringName, oldLine, oldStrKey):
        ...
        for stringKey in listStringKey:
            ...
            if stringKey == rStringKey:
                ...
                if i == 0:
                    ...
                    #     listString[rStringKey] = stringValue
                    #     listStringKey.append(rStringKey)
    # if listStringValue.__len__() == 0:
    #     listStringValue.append(stringValue)
    # else:
    #     sameCount = 0
    #     for string in listStringValue:
    ...
    # '''
    #
    # rStringKey = ''.join(stringName.group()).encode('utf-8')
    # # 此处有问题
    # if not same:
    #     if listStringKey.__len__() == 0:
    #         listStringKey.append(rStringKey)
    #     i = 0
    #     for stringKey in listStringKey:
    #         if stringKey == rStringKey:
...
restModules = ["rest.bo", "rest.charge", "rest.common.update",
               "rest.common.view","rest.core", "rest.navigation", "rest.service"]
shareModules = ["share_core", "share_login", "share_navigation",
                "share_service", "share_source", "share_utils", "share_widget"]

# rootDir = "/Users/flyer/Documents/Code/2D/Android/background-rest_phone"
# moduleDir = "/2dfire_share/" + shareModules[6]

#git 仓库名字   :可修改
# rootName = "GoodsModule"
...
#git仓库路径
# rootDir = diskPath + rootName

#仓库中的module路径  :可修改
# moduleDir = "/goods"

#module中java package路径
# javaCode = rootDir + moduleDir +"/src/main/java"
